(() => {
  ...
  mobileHomeFix.textContent=`
    @media (max-width:760px){
      ...
      .lock-footer-brand{
        ...
        border-bottom:1px solid rgba(198,150,67,.42)!important;
      }
      ...
      .lock-footer-brand strong{
        font-size:1.35rem!important;
      }
      .lock-footer-brand small{
        font-size:.65rem!important;
      }
      .lock-footer-brand em{
  ...
  if(brandingHeroImage){
    brandingHeroImage.src='assets/images/branding-hero-approved-final.jpg?v=20260730-1301';
    ...
    heroStyle.textContent=`
      ...
      .branding-detail .branding-hero-image img{width:100%!important;height:100%!important;object-fit:cover!important;object-position:center!important;filter:none!important}
    `;
